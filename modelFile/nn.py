...
columns_to_encode = ["Brand", "Fuel_Type", "Transmission", "Owner_Type"]

encoded_columns = []

for column_name in columns_to_encode:
    # Get the unique values in the column to determine the depth
    unique_values = data[column_name].unique()
    num_unique_values = len(unique_values)

    # Apply one-hot encoding
    one_hot_encoded = tf.one_hot(data[column_name], depth=num_unique_values)
